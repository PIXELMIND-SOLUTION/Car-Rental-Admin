...
const Bookings = () => {
  ...
  const filterBookings = useCallback(() => {
    ...
    setFilteredBookings(filtered);
    setCurrentPage(1);
  }, [bookings, allBookings, searchQuery, filterField, startDateFilter, endDateFilter, createdDateFilter]);
  ...
  const getPaginationInfo = () => {
    ...
    return `Showing ${filteredBookings.length} of ${pagination.totalBookings} bookings | Page ${pagination.currentPage} of ${pagination.totalPages}`;
  };
